  ...
  <div class="py-4 md:py-6 min-h-dvh bg-white grow" v-if="product">
    ...
    <div class="px-4 sm:px-6 lg:px-8 w-full max-w-(--ui-container) mx-auto">
        ...
        <div class="col-span-1 xl:col-span-2 h-full mb-8">
          <div class="flex flex-col-reverse md:flex-row gap-3 h-full">
            ...
            <!-- Main image + prev/next arrows — piyoladagi kabi surish
                 (swipe) mumkin bo'lgan karusel. Rang varianti tanlangan
                 bo'lsa (u galereya ro'yxatida yo'q, alohida rasm), statik
                 ko'rgazma ko'rsatiladi; aks holda ProductCard.vue'dagi bilan
            ...
            <div class="flex-1 relative rounded-2xl min-h-0 min-w-0">
              <div class="relative h-full">
                ...
                <template v-if="galleryImages.length > 1">
                  ...
                  <!-- Slide dots (faqat variant tanlanmagan holatda) -->
                  <div v-if="!selectedVariantImage" class="absolute bottom-1.5 inset-x-0 z-20 flex items-center justify-center gap-1 pointer-events-none">
                    <button
                      v-for="(img, idx) in galleryImages"
                      :key="idx"
                      type="button"
          ...
          <!-- Rang variantlari (agar mavjud bo'lsa) -->
          <div v-if="product.variants && product.variants.length > 0" class="flex items-center gap-2 mt-4 flex-wrap">
            <button
              ...
              :class="[
                'w-10 h-10 rounded-full overflow-hidden border-2 transition-all cursor-pointer bg-secondary-50 shrink-0',
      ...
      <!-- ====== O'XSHASH MAHSULOTLAR (bir xil kategoriyadagi boshqa
           kanselyariya mahsulotlari — real backend qidiruv orqali, joriy
           mahsulot chiqarib tashlanadi) ====== -->
...
// sursat) asosiy ko'rgazmada ko'rsatiladi va gallery indeksidan USTUN turadi.
...
// Asosiy rasm piyoladagi kabi surish (swipe) mumkin bo'lgan scroll-snap
// karusel (ProductCard.vue'dagi bilan bir xil mantiq).
