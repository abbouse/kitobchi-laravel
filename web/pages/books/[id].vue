  ...
  return [
    {
      ...
      user_name: 'Nazim',
      rating: 5,
      comment: 'Rahmat kotta kon ovoldim upakovkasi alohida tema hidi alohida vapshe udar'
    },
    {
      id: 2,
      user_name: 'Miraziz',
      rating: 5,
      comment: 'Dostavkani bunaqa tez yetkazib berasila dib oylamudim rahmat juda zor ishlaga rivoj.'
    },
    {
      id: 3,
      user_name: 'Bekzod',
      rating: 5,
      comment: 'Rahmat kitob juda sifatli ekan ishlarga omad'
    }
  ]
})
