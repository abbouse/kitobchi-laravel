  ...
  <div class="py-4 md:py-6 min-h-dvh bg-white grow" v-if="product">
    ...
    <div class="px-4 sm:px-6 lg:px-8 w-full max-w-(--ui-container) mx-auto">
      <!-- Breadcrumb (Desktop) — piyolada bu qatorda faqat orqaga strelka +
           ...
           jonli piyola desktop DOM'idan tasdiqlangan (product-page
           screenshot: heart icon rasm freymining o'ng yuqori burchagida). -->
      ...
      <div class="lg:grid lg:grid-cols-2 xl:grid-cols-3 gap-5 pb-24 lg:pb-0">
        ...
        <div class="col-span-1 space-y-6">
          ...
          <div class="p-6 rounded-3xl bg-secondary-100 space-y-5">
            ...
            <!-- Buttons — piyolada bitta marta shu yerda (To'lov usuli kartasi
                 ichida) ko'rinadi, faqat desktopda (mobileda pastki sticky
                 buy bar bor). -->
