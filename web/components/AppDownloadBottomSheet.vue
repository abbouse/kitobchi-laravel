      ...
      >
        ...
        >
          ...
          <a
            ...
            class="w-full bg-secondary-100 hover:bg-secondary-200 border border-neutral-200/80 rounded-2xl p-3.5 flex items-center justify-between transition-all duration-200 active:scale-[0.99] mb-3 text-neutral-900 no-underline cursor-pointer"
            @click="onStoreClick"
          >
            <div class="flex items-center gap-3.5">
              ...
              <div
                v-if="isIOS"
                class="w-12 h-12 rounded-2xl bg-black text-white flex items-center justify-center shrink-0 shadow-xs"
              >
              ...
              <!-- Official Google Play Container -->
              <div
                v-else
                class="w-12 h-12 rounded-2xl bg-white flex items-center justify-center shrink-0 border border-gray-200/80 shadow-xs"
              >
                <svg class="w-7 h-7" viewBox="0 0 512 512">
          ...
          <button
            type="button"
            class="w-full py-3.5 rounded-2xl bg-secondary-200 text-primary font-semibold text-[15px] hover:bg-secondary-300 active:scale-[0.99] transition font-['Urbanist',sans-serif] border-none cursor-pointer"
            @click="dismiss"
          >
            Keyinroq
          </button>
