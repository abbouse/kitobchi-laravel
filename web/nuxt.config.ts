  ...
  app: {
    head: {
      ...
      link: [
        ...
        { rel: 'icon', type: 'image/svg+xml', href: '/favicon.svg?v=20260819' },
        { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/favicon-32x32.png?v=20260819' },
        { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/favicon-16x16.png?v=20260819' },
        { rel: 'icon', type: 'image/png', sizes: '48x48', href: '/favicon-48x48.png?v=20260819' },

        // Apple Touch Icon
        { rel: 'apple-touch-icon', sizes: '180x180', href: '/apple-touch-icon.png?v=20260819' },

        // Manifest & Yandex Tableau
        { rel: 'manifest', href: '/site.webmanifest?v=20260819' },
