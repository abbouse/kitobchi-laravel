<?php $__env->startSection('title', 'Maxfiylik Siyosati'); ?>
...
<div class="l-doc-body kc-doc-static">
    ...
    <div class="doc-footer">
        <p style="font-weight: 600; margin-bottom: 12px;">
            <strong>Siyosat e'lon qilingan sana:</strong> <?php echo e(date('d.m.Y')); ?>

        </p>
        <p>
            <strong>Oxirgi yangilanish:</strong> <?php echo e(date('d.m.Y')); ?>
...
<?php echo $__env->make('legal.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/legal/privacy.blade.php ENDPATH**/ ?>