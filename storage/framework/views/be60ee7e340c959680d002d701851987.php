...
<aside id="sidebar"
    ...
    <div class="pt-8 pb-7 flex"
        ...
        'justify-start'">
        <a href="/">
            <b x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden"/>kitobchi.</b>
            <b x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block"/>kitobchi.</b>
            <b x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"/>k.</b>
...
<?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>