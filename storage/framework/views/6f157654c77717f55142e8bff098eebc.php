...
<div class="d-flex align-items-start justify-content-between mb-4 fade-up">
  <div class="d-flex align-items-center gap-3">
    <a href="<?php echo e(route('panel.orders.index')); ?>" class="btn-p ghost icon">
  ...
  <div class="p-card mb-3 fade-up d1">
    ...
    <div style="padding:16px;background:var(--p-elevated);border-radius:0 0 12px 12px;
      ...
      <div class="d-flex justify-content-between align-items-center mb-2"
        ...
        <span style="font-family:'DM Mono',monospace;font-weight:600;color:<?php echo e($row['color']); ?>">
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/orders/show.blade.php ENDPATH**/ ?>