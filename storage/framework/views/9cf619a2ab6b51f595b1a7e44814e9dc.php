...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.a122.page-header','data' => ['backHref' => ''.e(route('admin.gift-certificates.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('admin.gift-certificates.index')).'']); ?>
   ...
   <?php $__env->slot('meta', null, []); ?> 
    <p class="page-sub">
      ...
      <?php if($giftCertificate->expires_at && $giftCertificate->status === 'active'): ?>
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end"
          ...
          <li>
            <form method="POST"
                  action="<?php echo e(route('admin.gift-certificates.status', $giftCertificate)); ?>">
      ...
      <form method="POST"
            action="<?php echo e(route('admin.gift-certificates.cancel', $giftCertificate)); ?>"
      ...
      <div style="padding:0 18px 14px">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;
          ...
          <span style="font-size:12px;font-weight:500;color:var(--p-text);
                       font-family:'JetBrains Mono',monospace"><?php echo e($v); ?></span>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="">
        <div class="p-card h-100 fade-up">
          ...
          <div style="padding:16px 18px">
            ...
            <a href="<?php echo e(route('admin.users.show',$buyer->id)); ?>"
      ...
      <div class="">
        <div class="p-card h-100 fade-up">
          ...
          <div style="padding:16px 18px">
            ...
            <a href="<?php echo e(route('admin.users.show',$rec->id)); ?>"
               class="btn-p ghost sm" style="width:100%;justify-content:center">
              <i class="bi bi-person-lines-fill"></i> Profil
            </a>
            <?php else: ?>
            ...
            <div style="display:flex;flex-direction:column;gap:10px">
              ...
              <div>
                ...
                <div style="font-size:13px;font-weight:500;color:var(--p-text);
                            font-family:'JetBrains Mono',monospace"><?php echo e($v); ?></div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <?php endif; ?>

              <?php if($giftCertificate->status === 'active' && $giftCertificate->expires_at): ?>
              <div style="padding:10px;background:<?php echo e($giftCertificate->is_expired ? 'var(--p-danger-d)' : 'var(--p-warning-d)'); ?>;
                ...
                <i class="bi bi-<?php echo e($giftCertificate->is_expired ? 'x-circle' : 'clock'); ?> mr-1"></i>
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/a122/gift-certificates/show.blade.php ENDPATH**/ ?>