...
<div class="row g-3">
  ...
  <div class="col-xl-8">
    ...
    <div class="p-card mb-3">
      ...
      <div class="dash-card-body">
        <form method="POST" action="<?php echo e(route('panel.bot-tickets.close', $botTicket)); ?>">
  ...
  <div class="col-xl-4">
    ...
    <div class="p-card mb-3">
      ...
      <div class="dash-card-body">
        ...
        <?php if($botTicket->user_id): ?>
        <a href="<?php echo e(route('panel.users.index', ['search'=>$botTicket->user_id])); ?>"
    ...
    <div class="p-card mb-3">
      ...
      <div class="dash-card-body">
        ...
        <?php if(in_array($botTicket->status, ['queue','active'])): ?>
        <form method="POST" action="<?php echo e(route('panel.bot-tickets.assign', $botTicket)); ?>">
          <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
          <label class="p-label"><?php echo e($botTicket->operator ? 'Operatorni o\'zgartirish' : 'Operator tayinlash'); ?></label>
          <div class="d-flex gap-2 mt-1">
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/bot-tickets/show.blade.php ENDPATH**/ ?>