...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.api-clients.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.api-clients.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> <?php echo e($apiClient->name); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> API mijoz tahrirlash <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('panel.api-clients.update', $apiClient)); ?>">
      <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
      <?php echo $__env->make('panel.api-clients._form', compact('apiClient'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/api-clients/edit.blade.php ENDPATH**/ ?>