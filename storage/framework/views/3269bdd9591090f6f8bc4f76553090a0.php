...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.fcm-notifications.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.fcm-notifications.index')).'']); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('panel.fcm-notifications.store')); ?>">
      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="flex gap-2 justify-end fade-up">
        <a href="<?php echo e(route('panel.fcm-notifications.index')); ?>" class="btn-p ghost">Bekor qilish</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/fcm-notifications/create.blade.php ENDPATH**/ ?>