...
<?php $component->withAttributes([]); ?>
   ...
   <?php $__env->slot('actions', null, []); ?> 
    <a href="<?php echo e(route('panel.mystery-box.subscriptions')); ?>" class="btn-p ghost">
...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-3 items-start">
  ...
  <div class="xl:col-span-8">
    ...
    <div class="p-card mb-3 fade-up">
      ...
      <form method="POST" action="<?php echo e(route('panel.mystery-box.plans.update', $plan)); ?>">
      ...
      <form id="del<?php echo e($plan->id); ?>" method="POST"
            action="<?php echo e(route('panel.mystery-box.plans.destroy', $plan)); ?>" style="display:none">
  ...
  <div class="xl:col-span-4">
    <div class="p-card fade-up">
      ...
      <form method="POST" action="<?php echo e(route('panel.mystery-box.plans.store')); ?>">
        <?php echo csrf_field(); ?>
        <div style="padding:0 18px 18px">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="">
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/mystery-box/plans.blade.php ENDPATH**/ ?>