...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.courier-orders.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.courier-orders.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> Kuryer buyurtmasi #<?php echo e($courierOrder->id); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> <?php echo e($courierOrder->created_at?->format('d.m.Y H:i')); ?> <?php $__env->endSlot(); ?>
        ...
        <div class="table-responsive kc-twrap">
          <table class="p-table">
            ...
            <tbody>
              ...
              <tr>
                <td style="font-family:'JetBrains Mono',monospace;color:var(--p-accent)"><?php echo e($item->product_id); ?></td>
                <td>
                ...
                <td style="font-family:'JetBrains Mono',monospace"><?php echo e($item->quantity); ?></td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <div class="">
            <div style="background:var(--p-elevated);border-radius:10px;padding:16px;text-align:center">
              ...
              <div style="font-size:18px;font-weight:700;font-family:'JetBrains Mono',monospace;color:var(--p-<?php echo e($clr); ?>)"><?php echo e($val); ?></div>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/courier-orders/show.blade.php ENDPATH**/ ?>