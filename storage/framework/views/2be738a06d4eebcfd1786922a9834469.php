...
<div class="card p-5">
    <form method="POST" action="<?php echo e(route('admin.couriers.update', $courier)); ?>" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input
                ...
                value="<?php echo e(old('phone_number', $courier->phone_number ?? $courier->phone)); ?>"
            >
        </div>
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/a122/couriers/edit.blade.php ENDPATH**/ ?>