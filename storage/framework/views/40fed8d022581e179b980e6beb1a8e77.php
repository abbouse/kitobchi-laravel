...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.chats.index', ['tab' => $isShop ? 'seller' : 'user'])).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.chats.index', ['tab' => $isShop ? 'seller' : 'user'])).'']); ?>
    ...
    <div class="p-card mb-3 fade-up">
      ...
      <div style="padding:14px 18px">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:10px 0;
          ...
          <div>
            <a href="<?php echo e(route('panel.users.show',$p1Id)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/chats/show.blade.php ENDPATH**/ ?>