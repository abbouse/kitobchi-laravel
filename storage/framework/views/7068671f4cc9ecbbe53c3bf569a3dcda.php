...
<?php endif; ?>
<?php $component->withAttributes(['eyebrow' => 'Catalog','title' => 'Kitob kategoriyalari','subtitle' => 'Jami: '.e(number_format($stats['total'])).' · Faol: '.e(number_format($stats['active'])).'']); ?>
    <form method="GET" class="kc-search flex-grow-1" style="max-width: 22rem;">
      <i class="bi bi-search kc-search__icon"></i>
      <input name="search" value="<?php echo e(request('search')); ?>" placeholder="Kategoriya qidirish" class="form-control">
    </form>
    <a href="<?php echo e(route('admin.book-categories.create')); ?>" class="btn-p primary">
...
<?php endif; ?>
  ...
  <?php if(session('success')): ?>
    <div class="alert alert-success kc-flash mb-0"><?php echo e(session('success')); ?></div>
  <?php endif; ?>
  <?php if(session('error')): ?>
    <div class="alert alert-danger kc-flash mb-0"><?php echo e(session('error')); ?></div>
  <?php endif; ?>
      ...
      <table class="table align-middle mb-0">
        ...
        <tbody>
          <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              <td class="small text-secondary">#<?php echo e($cat->id); ?></td>
              <td class="fw-semibold"><?php echo e($cat->name_uz); ?></td>
              <td><?php echo e($cat->name_ru); ?></td>
              <td class="fs-5"><?php echo e($cat->icon); ?></td>
              <td><span class="badge rounded-pill text-bg-light border"><?php echo e(number_format($cat->books_count)); ?></span></td>
              <td>
                ...
                <div class="d-inline-flex align-items-center justify-content-end gap-1">
                  <form method="POST" action="<?php echo e(route('admin.book-categories.toggle', $cat)); ?>">
                    ...
                    <button class="btn btn-sm btn-light border kc-table-action" title="<?php echo e($cat->is_active ? 'Yashirish' : 'Faollashtirish'); ?>">
                      <i class="bi <?php echo e($cat->is_active ? 'bi-eye-slash' : 'bi-eye'); ?>"></i>
                    </button>
                  </form>
                  <a href="<?php echo e(route('admin.book-categories.edit', $cat)); ?>" class="btn btn-sm btn-light border kc-table-action" title="Tahrirlash">
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/a122/book-categories/index.blade.php ENDPATH**/ ?>