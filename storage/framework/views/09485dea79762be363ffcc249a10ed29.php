...
<div class="page-header fade-up d-flex align-items-start justify-content-between mb-4">
  <div class="d-flex align-items-center gap-3">
    <a href="<?php echo e(route('panel.seller-transactions.index')); ?>?segment=<?php echo e($segment); ?>"
       class="btn-p ghost icon">
      <i class="bi bi-arrow-left"></i>
    </a>
    <div>
      <h1 class="page-title">Tranzaksiya #<?php echo e($tx->id); ?></h1>
      <p class="page-sub" style="display:flex;align-items:center;gap:8px">
        ...
        <span class="s-pill <?php echo e($isCourier?'info':'warning'); ?>" style="font-size:10px">
          <i class="bi bi-<?php echo e($isCourier?'bicycle':'shop-window'); ?> me-1"></i>
          <?php echo e($isCourier?'Kuryer':'Seller'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/seller-transactions/show.blade.php ENDPATH**/ ?>