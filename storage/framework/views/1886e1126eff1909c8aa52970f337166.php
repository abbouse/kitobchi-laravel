<?php $__env->startSection('title', isset($bookCategory) ? 'Tahrirlash: '.$bookCategory->name_uz : "Yangi kategoriya"); ?>
<?php $__env->startSection('page-title', isset($bookCategory) ? 'Kategoriyani tahrirlash' : "Yangi kategoriya"); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.book-categories.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.book-categories.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> <?php echo e(isset($bookCategory) ? $bookCategory->name_uz : 'Yangi kategoriya'); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> <?php echo e(isset($bookCategory) ? 'Kategoriyani tahrirlash' : 'Yangi kitob kategoriyasi'); ?> <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <form method="POST"
      action="<?php echo e(isset($bookCategory) ? route('panel.book-categories.update',$bookCategory) : route('panel.book-categories.store')); ?>">
      <?php echo csrf_field(); ?>
      <?php if(isset($bookCategory)): ?> <?php echo method_field('PUT'); ?> <?php endif; ?>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div class="">
              ...
              <input type="text" name="icon" class="p-form-control" maxlength="2"
                     value="<?php echo e(old('icon', $bookCategory->icon ?? '')); ?>"
            ...
            <div class="">
              ...
              <input type="text" name="<?php echo e($field); ?>" class="p-form-control <?php $__errorArgs = [$field];
...
unset($__errorArgs, $__bag); ?>"
                     value="<?php echo e(old($field, $bookCategory->$field ?? '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <label style="display:flex;align-items:center;gap:6px;cursor:pointer;
              ...
              <input type="checkbox" name="tags[]" value="<?php echo e($tag->id); ?>"
                     ...
                     <?php echo e(in_array($tag->id, old('tags', $bookCategory?->tags?->pluck('id')->toArray() ?? [])) ? 'checked' : ''); ?>>
              <span style="font-size:12px;color:var(--p-text)"><?php echo e($tag->tag_name_uz); ?></span>
            </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
        </div>
      ...
      <div class="flex gap-2 justify-end">
        <a href="<?php echo e(route('panel.book-categories.index')); ?>" class="btn-p ghost">Bekor qilish</a>
        <button type="submit" class="btn-p primary"><i class="bi bi-check-lg"></i> Saqlash</button>
      </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/book-categories/edit.blade.php ENDPATH**/ ?>