...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.a122.page-header','data' => ['backHref' => ''.e(route('admin.chats.index', ['tab'=>'ai'])).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('admin.chats.index', ['tab'=>'ai'])).'']); ?>
   <?php $__env->slot('heading', null, []); ?> AI Chat <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> <?php echo e($conversation->name); ?> <?php echo e($conversation->lastname); ?>

      · <?php echo e($conversation->phone_number); ?> <?php $__env->endSlot(); ?>
  ...
  <div class="xl:col-span-3">
    <div class="card-panel mb-3 fade-up">
      ...
      <div style="padding:14px 18px">
        ...
        <a href="<?php echo e(route('admin.users.show', $conversation->user_id)); ?>"
          ...
          <div style="max-width:72%;
            ...
            <div style="display:flex;flex-wrap:wrap;gap:8px;margin-top:10px;max-width:480px">
              ...
              <?php
                ...
                $route  = $isBook
                  ? route('admin.books.show', $item->id)
                  : route('admin.stationery.show', $item->id);
              ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/a122/chats/show-ai.blade.php ENDPATH**/ ?>