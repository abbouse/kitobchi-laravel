  ...
  <div class="table-responsive">
    <table class="p-table">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <span style="font-family:'DM Mono',monospace;color:var(--p-accent);font-size:12px">#<?php echo e($user->id); ?></span>
          </td>
          <td>
          ...
          <td style="font-family:'DM Mono',monospace;font-size:12px"><?php if($user->phone_number): ?>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/users/index.blade.php ENDPATH**/ ?>