        ...
        <div class="container">
            <div class="footer-menu">
                <a href="<?php echo e(url('/')); ?>" class="footer-logo w-inline-block" aria-label="<?php echo e(__('nav.logo_aria')); ?>">
                    <div class="svg-embed cc-logo-icon w-embed">
                        <span class="kc-footer-monogram">k.</span>
                    </div>
                </a>
                ...
                <div class="footer-cell">
                    ...
                    <?php $__currentLoopData = \App\Models\Policy::active()->with('translations')->orderBy('sort_order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="mailto:info@kitobchi.com" class="footer-link"><?php echo e(__('nav.footer_help')); ?></a>
                </div>
                <div class="footer-cell">
            ...
            <div class="footer-large-logo w-embed kc-footer-mega-wrap">
                <svg class="kc-footer-word-svg" width="100%" height="100%" viewBox="0 0 1200 210" preserveAspectRatio="xMidYMin meet" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    <text x="600" y="138" fill="#fff" font-family="Messina Sans, sans-serif" font-size="208" font-weight="600" letter-spacing="-10.5" text-anchor="middle">kitobchi.</text>
                </svg>
            </div>
        </div>
    </div>
