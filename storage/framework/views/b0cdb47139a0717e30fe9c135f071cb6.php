                                ...
                                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div aria-roledescription="slide" class="kc-banner-slide min-w-0 shrink-0 ps-4 basis-[90%] md:basis-full justify-center" role="group">
                                        <?php if($banner->type === 'product'): ?>
                                            <a class="relative w-full aspect-520/141 h-hull rounded-2xl lg:rounded-[30px] overflow-hidden block group/item" href="<?php echo e($banner->url); ?>" rel="noopener noreferrer">
                                                <img alt="<?php echo e($banner->title); ?>" class="w-full h-full transform transition-transform duration-700 group-hover/item:scale-105 object-cover" fetchpriority="high" loading="eager" src="<?php echo e($banner->image); ?>"/>
                                        ...
                                        <?php else: ?>
                                            <div onclick="openBannerBottomSheet('<?php echo e(addslashes($banner->title)); ?>', '<?php echo e(addslashes($banner->description)); ?>', '<?php echo e($banner->image); ?>', '<?php echo e($banner->url); ?>')" class="relative w-full aspect-520/141 h-hull rounded-2xl lg:rounded-[30px] overflow-hidden block group/item cursor-pointer">
                                                <img alt="<?php echo e($banner->title); ?>" class="w-full h-full transform transition-transform duration-700 group-hover/item:scale-105 object-cover" fetchpriority="high" loading="eager" src="<?php echo e($banner->image); ?>"/>
                                                <div class="absolute inset-0 bg-primary/0 group-hover/item:bg-primary/10 transition-colors duration-300 pointer-events-none"></div>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="overflow-x-auto no-scrollbar">
                            <div class="flex items-start flex-row -ms-4 gap-[20px] pb-4">
                                ...
                                <div class="min-w-0 shrink-0 ps-4 basis-1/4 md:basis-1/6 lg:basis-1/8">
                                    <a class="group/item flex flex-col items-center gap-2" href="<?php echo e(route('web.catalog')); ?>">
                                ...
                                <?php $__currentLoopData = $webCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="min-w-0 shrink-0 ps-4 basis-1/4 md:basis-1/6 lg:basis-1/8">
                                        <a class="group/item flex flex-col items-center gap-2" href="<?php echo e(route('web.catalog', ['category' => $cat->id])); ?>">
                                            <div class="min-w-[90px] min-h-[90px] w-full h-full max-w-[192px] max-h-[192px] rounded-full overflow-hidden border border-transparent group-hover/item:border-primary-500 transition-colors duration-300 bg-gray-50">
                                                <div class="relative w-full aspect-square flex items-center justify-center">
                                                    <?php if($cat->image): ?>
                                                        <img alt="<?php echo e($cat->name_uz); ?>" class="w-full h-full object-cover transform transition-transform duration-500 group-hover/item:scale-110" loading="lazy" src="<?php echo e(asset('storage/' . $cat->image)); ?>"/>
                                                    <?php else: ?>
                                                        <span class="text-3xl font-black text-primary-500 opacity-50 uppercase"><?php echo e(mb_substr($cat->name_uz ?? 'K', 0, 1)); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <span class="font-medium md:font-semibold group-hover/item:font-bold group-hover/item:underline text-sm md:text-base leading-6 text-center text-neutral-900 dark:text-white group-hover/item:text-primary-500 transition-all duration-300">
        ...
        <section class="py-4 md:py-6 lg:py-10 max-lg:rounded-2xl max-lg:mb-2">
            <div class="px-4 sm:px-6 lg:px-8 w-full max-w-(--ui-container) mx-auto">
                <div class="flex justify-between items-center w-full px-1 max-md:mt-5 mb-4">
                    ...
                    <a class="text-sm font-semibold text-primary" href="<?php echo e(route('web.catalog')); ?>">
                        Barchasi
            ...
            <section class="py-4 md:py-6 lg:py-10 max-lg:rounded-2xl max-lg:mb-2">
                <div class="px-4 sm:px-6 lg:px-8 w-full max-w-(--ui-container) mx-auto">
                    <div class="flex justify-between items-center w-full px-1 max-md:mt-5 mb-4">
                        ...
                        <a class="text-sm font-semibold text-primary" href="<?php echo e(route('web.catalog', ['category' => $section->category->id])); ?>">
                            Barchasi
                            <span aria-hidden="true" class="iconify i-lucide:chevron-right"></span>
                        </a>
                    </div>
