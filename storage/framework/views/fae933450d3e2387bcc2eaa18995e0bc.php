...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.a122.page-header','data' => ['title' => 'Sozlamalar','subtitle' => 'Tizim konfiguratsiyasi va sozlamalari']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
          ...
          <div style="padding:16px;background:var(--p-elevated);border:1px solid var(--p-border);border-radius:10px">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input type="text" name="<?php echo e($key); ?>_phone" class="p-form-control"
                       value="<?php echo e(old($key.'_phone', $project?->{$key.'_phone'})); ?>"
                       placeholder="+998 XX XXX XX XX">
              </div>
              <div>
                <label class="p-form-label"><i class="bi bi-envelope mr-1"></i>Email manzil</label>
                <input type="email" name="<?php echo e($key); ?>_email" class="p-form-control"
                       value="<?php echo e(old($key.'_email', $project?->{$key.'_email'})); ?>"
  ...
  <div class="xl:col-span-5">
    <div class="p-card">
      ...
      <div class="flex items-center justify-between py-2" style="border-bottom:1px solid var(--p-border)">
        ...
        <?php if($val): ?>
          <span class="s-pill <?php echo e($clr); ?>" style="font-size:11px"><i class="bi bi-check-lg"></i> Yoqilgan</span>
        <?php else: ?>
          ...
          <div class="grid grid-cols-1 gap-3">
            <div>
              ...
              <input type="text" name="telegram_client_id" class="p-form-control"
                     value="<?php echo e(old('telegram_client_id', $project?->telegram_client_id)); ?>"
            ...
            <div>
              ...
              <input type="text" name="telegram_scopes" class="p-form-control"
                     value="<?php echo e(old('telegram_scopes', $project?->telegram_scopes ?? 'openid profile phone')); ?>"
            ...
            <tr>
              ...
              <td>
                <div class="flex gap-1 justify-end">
                  ...
                  <form method="POST" action="<?php echo e(route('admin.settings.commission.destroy', $c)); ?>"
...
function openEditCommission(id, from, to, pct) {
  document.getElementById('editCommissionForm').action = "<?php echo e(url('a122/settings/commission')); ?>/" + id;
            ...
            <tr>
              ...
              <td>
                <div class="flex gap-1 justify-end">
                  ...
                  <form method="POST" action="<?php echo e(route('admin.settings.cashback.destroy', $cb)); ?>"
                        onsubmit="return confirm('O\'chirilsinmi?')">
                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                    <button class="btn-p danger sm"><i class="bi bi-trash"></i></button>
                  </form>
        ...
        <table class="p-table" data-index-grid>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <form method="POST" action="<?php echo e(route('admin.settings.delivery.update', $d)); ?>" style="display:inline">
                  <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
              ...
              <td>
                <div class="flex gap-1">
                  ...
                  <form method="POST" action="<?php echo e(route('admin.settings.delivery.destroy', $d)); ?>"
                        onsubmit="return confirm('O\'chirilsinmi?')">
                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                    <button class="btn-p danger sm"><i class="bi bi-trash"></i></button>
                  </form>
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/a122/settings/index.blade.php ENDPATH**/ ?>