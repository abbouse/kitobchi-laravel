...
<?php $component->withAttributes([]); ?>
   ...
   <?php $__env->slot('actions', null, []); ?> 
    <a href="<?php echo e(route('panel.mystery-box.plans')); ?>" class="btn-p ghost">
...
<div class="p-card fade-up">
    ...
    <table class="p-table">
      ...
      <tbody>
        ...
        <tr style="<?php echo e($isOverdue ? 'background:var(--p-warning-d)' : ''); ?>">
          ...
          <td>
            <?php if($sub->user): ?>
            <a href="<?php echo e(route('panel.users.show',$sub->user_id)); ?>"
  ...
  <div class="flex justify-between items-center px-3 py-2"
    ...
    <?php echo e($subs->links('panel.partials.pagination')); ?>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/mystery-box/subscriptions.blade.php ENDPATH**/ ?>