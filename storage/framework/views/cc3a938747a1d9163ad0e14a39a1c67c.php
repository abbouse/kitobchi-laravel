...
<?php $component->withAttributes(['back-href' => ''.e(route('panel.users.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> <?php echo e($user->name); ?> <?php echo e($user->lastname); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> ID: #<?php echo e($user->id); ?>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/users/show.blade.php ENDPATH**/ ?>