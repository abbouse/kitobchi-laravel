...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.admins.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.admins.index')).'']); ?>
  ...
  <div class="xl:col-span-4">
    <div class="p-card">
      ...
      <div class="dash-card-body flex flex-col gap-2">
        <a href="<?php echo e(route('panel.admins.edit', $admin)); ?>" class="btn-p primary" style="justify-content:center">
          <i class="bi bi-pencil"></i> Tahrirlash
        </a>
        <?php if($admin->id !== auth('panel')->id()): ?>
        <form method="POST" action="<?php echo e(route('panel.admins.toggle', $admin)); ?>">
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/admins/show.blade.php ENDPATH**/ ?>