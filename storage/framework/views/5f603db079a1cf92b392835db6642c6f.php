...
<div class="login-card">
  ...
  <form method="POST" action="<?php echo e(route('panel.login.post')); ?>">
    ...
    <div style="margin-bottom:16px">
      ...
      <input type="email" name="email" class="form-control-p <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
             value="<?php echo e(old('email')); ?>" placeholder="admin@example.com" required autofocus>
      <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div style="font-size:11px;color:var(--danger);margin-top:4px"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    </div>
...
</html><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/auth/login.blade.php ENDPATH**/ ?>