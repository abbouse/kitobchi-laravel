...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.book-club.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.book-club.index')).'']); ?>
   ...
   <?php $__env->slot('actions', null, []); ?> 
    <div class="flex flex-wrap gap-2">
      ...
      <a href="<?php echo e(route('panel.book-club.edit', $bookClub)); ?>" class="btn-p ghost">
        <i class="bi bi-pencil"></i> Tahrirlash
      </a>
      <form method="POST" action="<?php echo e(route('panel.book-club.destroy', $bookClub)); ?>"
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-3">
  ...
  <div class="xl:col-span-8">
      ...
      <div class="dash-card-body">
        ...
        <div class="flex items-center gap-3 mb-3">
          ...
          <div style="margin-left:auto;font-size:12px;color:var(--p-info);display:flex;align-items:center;gap:6px">
            ...
            <span>Repost:
              <a href="<?php echo e(route('panel.users.show', $bookClub->reposted_user_id)); ?>"
    ...
    <div class="p-card fade-up">
      ...
      <div class="dash-card-body p-0">
        ...
        <div style="padding:16px 20px;border-bottom:1px solid var(--p-border)">
          ...
          <div class="flex gap-3">
            <a href="<?php echo e(route('panel.users.show', $comment->user_id)); ?>"
            ...
            <div style="flex:1;min-width:0">
              <div class="flex items-start justify-between gap-2">
                ...
                <div class="flex gap-1">
                  ...
                  <form method="POST"
                        action="<?php echo e(route('panel.book-club.comment.delete', $comment)); ?>"
              ...
              <div style="margin-top:12px;padding-left:16px;border-left:2px solid var(--p-border)">
                ...
                <div style="display:flex;gap:10px;margin-bottom:10px">
                  <a href="<?php echo e(route('panel.users.show', $reply->user_id)); ?>"
                  ...
                  <div style="flex:1">
                    <div class="flex items-center justify-between">
                      ...
                      <form method="POST"
                            action="<?php echo e(route('panel.book-club.comment.delete', $reply)); ?>"
      ...
      <?php echo e($comments->links('panel.partials.pagination')); ?>
  ...
  <div class="xl:col-span-4">
    ...
    <div class="p-card mb-3 fade-up">
      ...
      <div class="dash-card-body">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:8px 0;
                    border-bottom:1px solid var(--p-border)">
          <a href="<?php echo e(route('panel.users.show', $like->user_id)); ?>"
    ...
    <div class="p-card fade-up">
      ...
      <div class="dash-card-body">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:8px 0;
                    border-bottom:1px solid var(--p-border)">
          <a href="<?php echo e(route('panel.users.show', $rp->user_id)); ?>"
             style="width:32px;height:32px;border-radius:50%;overflow:hidden;flex-shrink:0;
          ...
          <a href="<?php echo e(route('panel.book-club.show', $rp)); ?>" class="btn-p ghost sm">
            <i class="bi bi-eye"></i>
          </a>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/book-club/show.blade.php ENDPATH**/ ?>