...
<div class="dash-template" data-template-dashboard data-chart='<?php echo json_encode($chartPayload, 15, 512) ?>'>
  <div class="page-head">
    <div>
    ...
    <div class="d-flex flex-wrap gap-2">
      <a href="<?php echo e(route('admin.dashboard.live')); ?>" target="_blank" class="btn btn-primary-gradient btn-sm">
        <i class="bi bi-broadcast me-1"></i>Live
      </a>
      <a href="<?php echo e(route('admin.dashboard', ['clear_cache' => 1])); ?>" class="btn btn-light border btn-sm">
  ...
  <div class="row g-3">
    <?php $__currentLoopData = $dashCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-xl-3 col-md-6">
        <div class="dash-stat-card h-100">
          <div class="d-flex align-items-start justify-content-between">
            <div class="dash-stat-icon" style="background: <?php echo e($card['color']); ?>"><i class="bi <?php echo e($card['icon']); ?>"></i></div>
            <span class="dash-stat-trend <?php echo e($card['down'] ? 'is-down' : ''); ?>">
              <i class="bi bi-<?php echo e($card['down'] ? 'arrow-down' : 'arrow-up'); ?>"></i> <?php echo e($card['trend']); ?>

            </span>
          </div>
          <div class="dash-stat-value"><?php echo e($card['value']); ?></div>
          <div class="dash-stat-label"><?php echo e($card['label']); ?></div>
        </div>
      </div>
  ...
  <?php if(!empty($alerts)): ?>
    <div class="row g-3">
      <?php $__currentLoopData = array_slice($alerts, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$color, $icon, $title, $desc, $url]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
          $tone = match($color) {
            'danger' => 'danger',
            'warning' => 'warning',
        ...
        ?>
        <div class="col-xl-3 col-md-6">
          <a href="<?php echo e($url); ?>" class="card-panel d-flex align-items-center gap-3 h-100 text-decoration-none">
            <span class="dash-activity-icon bg-<?php echo e($tone); ?>-subtle text-<?php echo e($tone); ?>-emphasis"><i class="bi <?php echo e($icon); ?>"></i></span>
            <span class="min-w-0">
              <span class="d-block fw-bold text-truncate"><?php echo e($title); ?></span>
              <span class="d-block small text-secondary text-truncate"><?php echo e($desc); ?></span>
            </span>
          </a>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-xl-4">
      <div class="card-panel h-100">
        ...
        <div class="d-flex flex-wrap gap-2 mt-2">
          <?php $__currentLoopData = $categoryShare; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="chip chip-gray">
              <span style="width:8px;height:8px;border-radius:50%;background:<?php echo e($item['color']); ?>;display:inline-block"></span>
  ...
  <div class="row g-3">
    <div class="col-xl-8">
      <div class="card-panel">
        <div class="panel-head">
          ...
          <a href="<?php echo e(route('admin.books.index')); ?>" class="small text-decoration-none fw-semibold" style="color:#4f46e5">Katalog</a>
        </div>
        <div class="table-responsive">
          <table class="data-table">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $topMixedProducts->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php $cover = $extractImage($product->images ?? null); ?>
                <tr>
                  <td>
                    <?php if($cover): ?>
                      <img src="<?php echo e($cover); ?>" alt="" class="thumb">
                    <?php else: ?>
                  ...
                  <td>
                    ...
                    <div class="small text-secondary"><?php echo e($product->author ?? '—'); ?></div>
                  </td>
                  <td><span class="chip <?php echo e($product->_type === 'stationery' ? 'chip-warning' : 'chip-purple'); ?>"><?php echo e($product->_type === 'stationery' ? 'Kanstovar' : 'Kitob'); ?></span></td>
                  <td class="fw-semibold"><?php echo e(number_format($product->sold_count)); ?></td>
                  <td class="fw-semibold text-success"><?php echo e($fmtMoney($product->total_revenue)); ?> UZS</td>
                </tr>
    ...
    <div class="col-xl-4">
      <div class="card-panel h-100">
        ...
        <div>
          <?php $__empty_1 = true; $__currentLoopData = $recentOrders->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="dash-activity-row">
              ...
              <div class="flex-grow-1 min-w-0">
                <div class="small fw-semibold text-truncate">#<?php echo e($order['id']); ?> · <?php echo e($order['customer']); ?></div>
                <div class="small text-secondary"><?php echo e($order['date']); ?></div>
              </div>
              <div class="text-end">
                <div class="small fw-bold text-nowrap"><?php echo e($order['amount']); ?></div>
                <span class="chip chip-<?php echo e($statusTone); ?>"><?php echo e($order['status']); ?></span>
              </div>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="row g-2">
          <?php $__currentLoopData = $quickLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-3 col-6">
              <a href="<?php echo e($link['href']); ?>" class="text-decoration-none d-flex align-items-center gap-2 p-3 rounded border h-100">
                <span class="dash-product-rank"><i class="bi <?php echo e($link['icon']); ?>"></i></span>
                <span class="min-w-0">
                  <span class="d-block fw-semibold text-truncate"><?php echo e($link['label']); ?></span>
                  <span class="d-block small text-secondary text-truncate"><?php echo e($link['meta']); ?></span>
                </span>
              </a>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-xl-4">
      <div class="card-panel h-100">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $topBuyers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $buyer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="dash-activity-row">
            <div class="dash-product-rank <?php echo e($index === 0 ? 'text-warning' : ''); ?>"><?php echo e($index + 1); ?></div>
            <div class="flex-grow-1 min-w-0">
              <div class="fw-semibold text-truncate"><?php echo e(trim(($buyer->user?->name ?? 'User') . ' ' . ($buyer->user?->lastname ?? ''))); ?></div>
              <div class="small text-secondary"><?php echo e(number_format($buyer->order_count)); ?> buyurtma</div>
            </div>
            <div class="fw-bold text-nowrap"><?php echo e($fmtMoney($buyer->total_spent)); ?></div>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
