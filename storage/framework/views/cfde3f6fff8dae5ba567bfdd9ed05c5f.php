  ...
  <section class="dash-ops-header">
    <div>
      ...
      <div class="dash-ops-header__meta">
        <?php $__currentLoopData = $opsHeaderPills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon, $text]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <span class="dash-ops-pill"><i class="bi <?php echo e($icon); ?>"></i><?php echo e($text); ?></span>
