...
<div class="d-flex align-items-start justify-content-between mb-4 fade-up">
  <div class="d-flex align-items-center gap-3">
    <a href="<?php echo e(route('panel.mystery-box.subscriptions')); ?>" class="btn-p ghost icon">
      <i class="bi bi-arrow-left"></i>
    </a>
    <div>
      <h1 class="page-title">Obuna #<?php echo e($subscription->id); ?></h1>
      <p class="page-sub" style="display:flex;align-items:center;gap:8px">
        <?php echo e($subscription->created_at?->format('d.m.Y')); ?>

        <span class="s-pill <?php echo e($subscription->status_color); ?>" style="font-size:11px">
    ...
    <div class="p-card fade-up">
      ...
      <div style="padding:16px 18px;border-top:1px solid var(--p-border)">
        ...
        <div style="margin-top:8px;font-size:12px;color:var(--p-muted);
          ...
          <i class="bi bi-info-circle me-1"></i><?php echo e($delivery->tracking_note); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/mystery-box/subscription-show.blade.php ENDPATH**/ ?>