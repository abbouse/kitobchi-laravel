...
<div class="d-flex align-items-center gap-3 mb-4 fade-up">
  <a href="<?php echo e(route('panel.chats.index', ['tab' => $isShop ? 'seller' : 'user'])); ?>"
     class="btn-p ghost icon">
    <i class="bi bi-arrow-left"></i>
  </a>
  <div>
    <h1 class="page-title">Suhbat #<?php echo e($conversation->id); ?></h1>
    <p class="page-sub">
      <?php echo e($p1Name); ?> ↔
      <?php if($isShop): ?>
        <i class="bi bi-shop-window me-1"></i><?php echo e($p2Name); ?>
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:10px 0">
          ...
          <div>
            ...
            <a href="<?php echo e($p2Route); ?>"
               style="font-size:13px;font-weight:500;color:var(--p-text);text-decoration:none">
              <?php if($isShop): ?><i class="bi bi-shop-window me-1" style="color:var(--p-warning)"></i><?php endif; ?>
              <?php echo e($p2Name); ?>
    ...
    <div class="p-card fade-up">
      <div class="p-card-header">
        ...
        <span class="s-pill danger" style="font-size:10px">
          <i class="bi bi-flag-fill me-1"></i><?php echo e(count($reportedIds)); ?> shikoyatli
        </span>
        <?php endif; ?>
      </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/chats/show.blade.php ENDPATH**/ ?>