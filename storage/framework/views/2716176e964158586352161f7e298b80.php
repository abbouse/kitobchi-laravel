...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
  <div>
    <h2 class="text-xl font-bold">Kanstovar Kategoriyalari</h2>
  ...
  <div class="flex items-center gap-2">
    ...
    <a href="<?php echo e(route('admin.stationery-categories.create')); ?>" class="btn btn-primary">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td><span class="font-semibold"><?php echo e($cat->stationeries_count); ?></span></td>
            <td>
            ...
            <td>
              <div class="flex items-center justify-end gap-1">
                ...
                <a href="<?php echo e(route('admin.stationery-categories.edit', $cat)); ?>" class="btn-ghost p-2 rounded-lg">
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/a122/stationery-categories/index.blade.php ENDPATH**/ ?>