    ...
    <div class="mb-5 grid grid-cols-2 gap-4">
        <div class="rounded-xl bg-green-50 p-4 dark:bg-green-900/10">
            ...
            <p class="text-lg font-bold text-green-700 dark:text-green-300">
                <?php echo e(number_format($totalPayout, 0, '.', ' ')); ?> so'm
            </p>
        </div>
        <div class="rounded-xl bg-orange-50 p-4 dark:bg-orange-900/10">
            ...
            <p class="text-lg font-bold text-orange-700 dark:text-orange-300">
                <?php echo e(number_format($commission, 0, '.', ' ')); ?> so'm
            </p>
        </div>
    </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm font-semibold text-gray-800 dark:text-white/90"><?php echo e(number_format($pendingCount)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm font-semibold text-gray-800 dark:text-white/90"><?php echo e(number_format($paidCount)); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm font-semibold text-gray-800 dark:text-white/90"><?php echo e(number_format($rejectedCount)); ?></span>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/components/ecommerce/expense-breakdown.blade.php ENDPATH**/ ?>