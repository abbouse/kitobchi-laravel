  ...
  <div class="dash-card-body">
    ...
    <div class="flex items-start justify-between mb-3">
      <div class="flex items-center gap-3">
        ...
        <a href="<?php echo e(route('panel.users.show', $post->user_id)); ?>"
      ...
      <div class="flex gap-1">
        <a href="<?php echo e(route('panel.book-club.show', $post)); ?>" class="btn-p ghost sm">
          <i class="bi bi-eye"></i>
        </a>
        <a href="<?php echo e(route('panel.book-club.edit', $post)); ?>" class="btn-p ghost sm">
          <i class="bi bi-pencil"></i>
        </a>
        <form method="POST" action="<?php echo e(route('panel.book-club.destroy', $post)); ?>"
...
</div><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/book-club/_post-card.blade.php ENDPATH**/ ?>