...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.stationery.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.stationery.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> <?php echo e($stationery->name); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> ID: #<?php echo e($stationery->id); ?> · <?php echo e($stationery->category?->name_uz ?? '—'); ?> <?php $__env->endSlot(); ?>
        ...
        <div class="table-responsive kc-twrap">
          <table class="p-table">
            ...
            <tbody>
              ...
              <tr>
                <td style="font-family:'JetBrains Mono',monospace;color:var(--p-accent)"><?php echo e($v->id); ?></td>
    ...
    <div class="p-card">
      ...
      <div class="dash-card-body">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;padding:9px 0;border-bottom:1px solid var(--p-border)">
          ...
          <span style="font-size:13px;font-weight:600;font-family:'JetBrains Mono',monospace;color:var(--p-<?php echo e($clr); ?>)"><?php echo e($val); ?></span>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/stationeries/show.blade.php ENDPATH**/ ?>