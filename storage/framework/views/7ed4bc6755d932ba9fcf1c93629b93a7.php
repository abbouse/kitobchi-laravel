...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.promocodes.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.promocodes.index')).'']); ?>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-3">
  <div class="xl:col-span-4">
    ...
    <a href="<?php echo e(route('panel.promocodes.edit', $promocode)); ?>" class="btn-p primary" style="width:100%;justify-content:center;margin-bottom:8px">
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/promocodes/show.blade.php ENDPATH**/ ?>