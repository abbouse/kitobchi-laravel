      ...
      <?php $__empty_1 = true; $__currentLoopData = $pendingPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div style="padding:16px 20px;border-bottom:1px solid var(--p-border)">
          <div class="flex flex-wrap items-start justify-between gap-3 mb-2">
            <div>
              <a href="<?php echo e(route('panel.book-club.show', $row)); ?>" class="font-semibold" style="color:var(--p-text);text-decoration:none">
          ...
          <?php endif; ?>
          <form method="POST" action="<?php echo e(route('panel.book-club.post-ugc-score', $row)); ?>" class="flex flex-wrap items-end gap-2">
            <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('panel.book-club.show', $row)); ?>" class="btn-p ghost sm">Post sahifasi</a>
          </form>
        </div>
      ...
      <?php $__empty_1 = true; $__currentLoopData = $pendingComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div style="padding:16px 20px;border-bottom:1px solid var(--p-border)">
          <div class="flex flex-wrap items-start justify-between gap-2 mb-2">
            <div>
              <?php if($c->post): ?>
                <a href="<?php echo e(route('panel.book-club.show', $c->post)); ?>" style="font-size:13px;font-weight:600;color:var(--p-accent);text-decoration:none">
          ...
          <?php endif; ?>
          <form method="POST" action="<?php echo e(route('panel.book-club.comment.ugc-score', $c)); ?>" class="flex flex-wrap items-end gap-2">
            <?php echo csrf_field(); ?>
            <label class="text-xs" style="color:var(--p-hint)">Bahosi (1–5)</label>
            <select name="star" class="p-form-control" style="width:90px" required>
              <?php for($s = 1; $s <= 5; $s++): ?>
            ...
            <button type="submit" class="btn-p primary sm"><i class="bi bi-check2"></i> Saqlash</button>
            <?php if($c->post): ?>
              <a href="<?php echo e(route('panel.book-club.show', $c->post)); ?>" class="btn-p ghost sm">Post sahifasi</a>
            <?php endif; ?>
          </form>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/book-club/moderation-queue.blade.php ENDPATH**/ ?>