...
<?php $component->withAttributes([]); ?>
   <?php $__env->slot('heading', null, []); ?> Reklamalar <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> Sotuvchilar reklama bannerlarini moderatsiya <?php $__env->endSlot(); ?>
   <?php $__env->slot('actions', null, []); ?> 
    <a href="<?php echo e(route('panel.seller-ads.settings')); ?>" class="btn-p ghost">
...
<div class="filter-bar mb-3">
  <form method="GET" class="flex flex-wrap gap-2">
    ...
    <a href="<?php echo e(route('panel.seller-ads.index',['tab'=>$tab])); ?>" class="btn-p ghost"><i class="bi bi-x"></i></a>
  </form>
</div>
...
<div class="p-card p-0">
    ...
    <table class="p-table" style="min-width:780px">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <?php if($ad->seller): ?>
            <a href="<?php echo e(route('panel.sellers.show', $ad->seller_id)); ?>"
          ...
          <td>
            <div class="flex gap-1">
              ...
              <form method="POST" action="<?php echo e(route('panel.seller-ads.moderate', $ad)); ?>">
              ...
              <?php endif; ?>
              <a href="<?php echo e(route('panel.seller-ads.show', $ad)); ?>" class="btn-p ghost sm"><i class="bi bi-eye"></i></a>
            </div>
          </td>
        </tr>
  ...
  <?php if($ads->hasPages()): ?>
  <div class="p-pagination"><?php echo e($ads->links('panel.partials.pagination')); ?></div>
  <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/seller-ads/index.blade.php ENDPATH**/ ?>