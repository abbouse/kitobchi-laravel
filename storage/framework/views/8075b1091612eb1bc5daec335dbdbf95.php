        ...
        <div class="p-4 rounded-lg border border-amber-200 bg-amber-50/60 dark:bg-amber-400/5 dark:border-amber-400/20">
            <div class="flex items-start gap-3">
                <input type="checkbox" name="isPremiumShop" id="isPremiumShop" value="1"
                       ...
                       <?php echo e(old('isPremiumShop', $seller->isPremiumShop) ? 'checked' : ''); ?>
            ...
            <div id="premiumExpiryWrap" class="mt-3 <?php echo e(old('isPremiumShop', $seller->isPremiumShop) ? '' : 'hidden'); ?>">
                ...
                <input name="isPremiumExpiresAt" type="datetime-local" class="input"
                       value="<?php echo e(old('isPremiumExpiresAt', optional($seller->isPremiumExpiresAt)->format('Y-m-d\TH:i'))); ?>">
                <?php if($seller->isPremiumExpiresAt): ?>
                    <p class="text-[10px] text-gray-400 mt-1">
                        Hozirgi tugash: <span class="font-mono"><?php echo e($seller->isPremiumExpiresAt->format('Y-m-d H:i')); ?></span>
                    </p>
                <?php endif; ?>
            </div>
        </div>
