...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.reels.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.reels.index')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> <?php echo e($reel->title); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> Tartib: <?php echo e($reel->order); ?>

        · <?php echo e($reel->items->count()); ?> ta video
        · Yaratildi: <?php echo e($reel->created_at?->format('d.m.Y')); ?> <?php $__env->endSlot(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/reels/show.blade.php ENDPATH**/ ?>