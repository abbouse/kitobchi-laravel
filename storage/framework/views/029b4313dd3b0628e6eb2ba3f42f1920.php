...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel.page-header','data' => ['backHref' => ''.e(route('panel.mystery-box.subscriptions')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['back-href' => ''.e(route('panel.mystery-box.subscriptions')).'']); ?>
   <?php $__env->slot('heading', null, []); ?> Obuna #<?php echo e($subscription->id); ?> <?php $__env->endSlot(); ?>
   <?php $__env->slot('actions', null, []); ?> 
    <div class="flex gap-2">
        <?php if($subscription->status === 'active'): ?>
        <form method="POST" action="<?php echo e(route('panel.mystery-box.pause', $subscription)); ?>">
          <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
          <button class="btn-p ghost"><i class="bi bi-pause-fill"></i> To'xtatish</button>
        </form>
        <?php elseif($subscription->status === 'paused'): ?>
        <form method="POST" action="<?php echo e(route('panel.mystery-box.resume', $subscription)); ?>">
          <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
        ...
        <form method="POST" action="<?php echo e(route('panel.mystery-box.cancel', $subscription)); ?>"
  ...
  <div class="xl:col-span-4">
    ...
    <div class="p-card mb-3 fade-up">
      ...
      <div style="padding:14px 18px">
        ...
        <a href="<?php echo e(route('panel.users.show',$subscription->user_id)); ?>"
      ...
      <div style="padding:16px 18px;border-top:1px solid var(--p-border)">
        ...
        <div class="flex flex-wrap gap-2 mb-3">
          ...
          <?php
            ...
            $img  = $imgs[0] ?? null;
          ?>
          <a href="<?php echo e(route('panel.books.show',$book->id)); ?>" target="_blank"
        ...
        <form method="POST"
              action="<?php echo e(route('panel.mystery-box.delivery.prepare', $delivery)); ?>"
        ...
        <div class="flex gap-2">
          <form method="POST" action="<?php echo e(route('panel.mystery-box.delivery.ship', $delivery)); ?>">
            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
        ...
        <form method="POST" action="<?php echo e(route('panel.mystery-box.delivery.deliver', $delivery)); ?>">
          <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/mystery-box/subscription-show.blade.php ENDPATH**/ ?>