...
<div class="d-flex align-items-center justify-content-between mb-4">
  ...
  <a href="<?php echo e(route('panel.stationery-categories.create')); ?>" class="btn-p">
    ...
    <table class="p-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="font-size:11px;color:var(--p-hint);font-family:'DM Mono',monospace"><?php echo e($cat->slug ?: '—'); ?></td>
          <td>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/stationery-categories/index.blade.php ENDPATH**/ ?>