...
<?php $component->withAttributes([]); ?>
   <?php $__env->slot('heading', null, []); ?> Kantselyariya mahsulotlari <?php $__env->endSlot(); ?>
   <?php $__env->slot('meta', null, []); ?> Sotuvchilar yuklagan mahsulotlar moderatsiyasi <?php $__env->endSlot(); ?>
...
<div class="grid grid-cols-2 xl:grid-cols-4 gap-3 mb-4">
  ...
  <div class="">
    <div class="p-card flex items-center gap-3">
      ...
      <div>
        <div style="font-size:22px;font-weight:700;font-family:'JetBrains Mono',monospace;color:var(--p-text)"><?php echo e(number_format($counts[$key])); ?></div>
...
<div class="p-card p-0">
  <div class="table-responsive kc-twrap">
    <table class="p-table">
      ...
      <tbody>
        ...
        ?>
        <tr>
          <td style="font-family:'JetBrains Mono',monospace;color:var(--p-accent);font-weight:600"><?php echo e($item->id); ?></td>
          <td>
          ...
          <td style="font-family:'JetBrains Mono',monospace;font-size:12px;color:var(--p-muted)"><?php echo e(number_format($item->totalSales)); ?></td>
          <td>
  ...
  <div class="p-pagination"><?php echo e($stationeries->links('panel.partials.pagination')); ?></div>
  <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi/resources/views/panel/stationeries/index.blade.php ENDPATH**/ ?>