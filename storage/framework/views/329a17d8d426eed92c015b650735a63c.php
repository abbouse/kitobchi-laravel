...
<div class="d-flex align-items-center justify-content-between mb-4 fade-up">
  <div class="d-flex align-items-center gap-3">
    <a href="<?php echo e(route('panel.book-club.index')); ?>" class="btn-p ghost icon">
      <i class="bi bi-arrow-left"></i>
    </a>
    <div>
      <h1 class="page-title">Post #<?php echo e($bookClub->id); ?></h1>
      <p class="page-sub">
      ...
      <div class="dash-card-body">
        ...
        <div style="background:var(--p-elevated);border-radius:10px;padding:14px;margin-bottom:12px">
          <div style="font-size:12px;color:var(--p-hint);margin-bottom:10px;
            ...
            <i class="bi bi-bar-chart me-1"></i> So'rovnoma · <?php echo e($totalVotes); ?> ta ovoz
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/book-club/show.blade.php ENDPATH**/ ?>