...
<div class="card p-5">
    <form method="POST" action="<?php echo e(route('admin.reels.store')); ?>" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <input
                ...
                class="input"
                min="0"
                value="<?php echo e(old('order', $nextOrder)); ?>"
...
<?php echo $__env->make('a122.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/abbos/PROJECTS/MY/kitobchi-server/kitobchi-laravel/resources/views/a122/reels/create.blade.php ENDPATH**/ ?>