  ...
  <div class="table-responsive">
    <table class="p-table">
      ...
      <tbody>
        ...
        <tr>
          <td><span style="font-family:'DM Mono',monospace;color:var(--p-accent);font-size:12px">#<?php echo e($book->id); ?></span></td>
          <td>
          ...
          <td>
            <div style="font-family:'DM Mono',monospace;font-size:12px;font-weight:500;color:var(--p-text)"><?php echo e(number_format($book->price)); ?></div>
            <?php if($book->discountPrice > 0): ?>
            <div style="font-family:'DM Mono',monospace;font-size:11px;color:var(--p-success)">-<?php echo e(number_format($book->discountPrice)); ?></div>
            <?php endif; ?>
          </td>
          <td>
            <span style="font-family:'DM Mono',monospace;font-size:13px;font-weight:500;color:var(--p-text)"><?php echo e($book->count); ?></span>
...
<?php echo $__env->make('panel.layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/www-root/data/www/kitobchi.com/resources/views/panel/books/index.blade.php ENDPATH**/ ?>