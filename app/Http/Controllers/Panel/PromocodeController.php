...
class PromocodeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('panel.promocodes.index', compact('promocodes', 'counts', 'tab'));
    }

    public function create()
    {
        return view('panel.promocodes.edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('panel.promocodes.index')->with('success', "Promokod qo'shildi.");
    }
    ...
    public function show(Promocode $promocode)
    {
        ...
        return view('panel.promocodes.show', compact('promocode', 'histories'));
    }

    public function edit(Promocode $promocode)
    {
        return view('panel.promocodes.edit', compact('promocode'));
    }
    ...
    public function update(Request $request, Promocode $promocode)
    {
        ...
        $promocode->update($request->only([
            'type', 'amount', 'min_order_amount', 'usesLimit', 'expires_at', 'status',
        ]));
    ...
    {
        $promocode->delete();
        return redirect()->route('panel.promocodes.index')->with('success', "Promokod o'chirildi.");
    }
