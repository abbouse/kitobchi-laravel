...
#[\MoonShine\UI\Components\Icon('heroicons.outline.rocket-launch')]
class SoldResource extends ModelResource
{
        ...
        return [
            ...
            Json::make('Buyurtma tarkibi', 'items')->fields([
                ...
                Text::make(
                    "Do'kon", 'seller_id',
                    fn($item) => (string)(
                        ($sid = data_get($item, 'seller_id')) && ($shop = Seller::find($sid))
            ...
            Json::make('Yetkazish', 'address')->fields([
                ...
                Text::make(
                    'Joylashuv', 'location',
                    fn($address) => (string)(
                        data_get($address, 'lat') && data_get($address, 'lon')
    ...
    protected function formFields(): iterable
    {
        return [
            ...
            Enum::make('Buyurtma holati', 'status')
