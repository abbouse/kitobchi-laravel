...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE books MODIFY kangaroo_listing_score DECIMAL(3,2) NULL');
        DB::statement('ALTER TABLE stationeries MODIFY kangaroo_listing_score DECIMAL(3,2) NULL');
    }
};
