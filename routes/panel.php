...
Route::prefix('panel')->name('panel.')->group(function () {
    ...
    Route::middleware('auth.panel')->group(function () {
        ...
        Route::post('theme', function (\Illuminate\Http\Request $req) {
            session(['theme' => $req->input('theme', 'dark')]);
            return back();
        })->name('theme');
        ...
        Route::middleware('panel.permission:settings')
            ->prefix('settings')->name('settings.')->group(function () {
                ...
                Route::put('/commission',                     [SettingsController::class, 'updateCommission'])->name('commission.update');
                Route::post('/cashback',                      [SettingsController::class, 'storeCashback'])->name('cashback.store');
                Route::put('/cashback/{cashbackSettings}',    [SettingsController::class, 'updateCashback'])->name('cashback.update');
                Route::delete('/cashback/{cashbackSettings}', [SettingsController::class, 'destroyCashback'])->name('cashback.destroy');
