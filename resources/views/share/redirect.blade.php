...
<div class="card">
    ...
    <h1>Kitobchi</h1>
    <p>{{ $description ?? "Kitobchi ilovasida ko'rish uchun quyidagi tugmani bosing" }}</p>

    {{-- Asosiy tugma — app ochish --}}
