...
<x-panel.page-header title="Sozlamalar" subtitle="Tizim konfiguratsiyasi va sozlamalari"/>
...
<div class="tab-pills fade-up mb-4">
  ...
  <a href="{{ route('panel.settings.index', ['tab'=>$key]) }}"
...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-4">
  <div class="xl:col-span-7">
    <div class="p-card">
      ...
      <form method="POST" action="{{ route('panel.settings.versions') }}">
        @csrf @method('PUT')
...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-4">
            ...
            <tr>
              ...
              <td>
                <div class="flex gap-1 justify-end">
                  ...
                  <form method="POST" action="{{ route('panel.settings.commission.destroy', $c) }}"
  ...
  <div class="xl:col-span-4">
    <div class="p-card">
      ...
      <form method="POST" action="{{ route('panel.settings.commission.store') }}">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
...
function openEditCommission(id, from, to, pct) {
  document.getElementById('editCommissionForm').action = "{{ url('panel/settings/commission') }}/" + id;
...
<div class="grid grid-cols-1 xl:grid-cols-12 gap-4">
            ...
            <tr>
              ...
              <td>
                <div class="flex gap-1 justify-end">
                  ...
                  <form method="POST" action="{{ route('panel.settings.cashback.destroy', $cb) }}"
                        onsubmit="return confirm('O\'chirilsinmi?')">
                    @csrf @method('DELETE')
                    <button class="btn-p danger sm"><i class="bi bi-trash"></i></button>
                  </form>
  ...
  <div class="xl:col-span-4">
    <div class="p-card">
      ...
      <form method="POST" action="{{ route('panel.settings.cashback.store') }}">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
...
function openEditCashback(id, from, to, cb) {
  document.getElementById('editCashbackForm').action = "{{ url('panel/settings/cashback') }}/" + id;
        ...
        <table class="p-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <form method="POST" action="{{ route('panel.settings.delivery.update', $d) }}" style="display:inline">
                  @csrf @method('PUT')
              ...
              <td>
                <div class="flex gap-1">
                  ...
                  <form method="POST" action="{{ route('panel.settings.delivery.destroy', $d) }}"
                        onsubmit="return confirm('O\'chirilsinmi?')">
                    @csrf @method('DELETE')
                    <button class="btn-p danger sm"><i class="bi bi-trash"></i></button>
                  </form>
