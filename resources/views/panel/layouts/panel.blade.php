...
<title>@yield('title', 'Admin paneli') | Kitobchi</title>
<style>[x-cloak]{display:none!important}</style>

{{-- Tailwind + panel primitives + kitobchi-panel (Vite); Bootstrap keyin --}}
@vite(['resources/css/app.css', 'resources/js/app.js'])
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.3/css/bootstrap.min.css" rel="stylesheet"/>
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.11.3/font/bootstrap-icons.min.css" rel="stylesheet"/>

{{-- Alpine.js Stores (defined before Alpine.start() fires) --}}
<script>
...
{{-- Prevent dark-mode flash (runs before body renders — like TailAdmin) --}}
<script>
(function() {
    const theme = localStorage.getItem('kitobchi_theme') || '{{ session('theme', 'dark') }}';
    if (theme === 'dark') {
...
<body class="bg-gray-50 selection:bg-brand-500/20 selection:text-gray-900 dark:selection:bg-brand-400/25 dark:selection:text-white"
  ...
  <div class="min-h-screen xl:flex">
    ...
    {{-- Backdrop — TailAdmin layouts/backdrop.blade.php bilan bir xil (+ yopish uchun click) --}}
