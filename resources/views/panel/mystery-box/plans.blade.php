...
<div class="d-flex align-items-start justify-content-between mb-4 fade-up">
  <div>
    <h1 class="page-title">Mystery Box tariflar</h1>
    <p class="page-sub">Foydalanuvchilarga ko'rsatiladigan obuna rejalari</p>
  </div>
  <a href="{{ route('panel.mystery-box.subscriptions') }}" class="btn-p ghost">
...
<div class="row g-3 align-items-start">
  ...
  <div class="col-xl-8">
    ...
    <div class="p-card mb-3 fade-up">
      ...
      <form method="POST" action="{{ route('panel.mystery-box.plans.update', $plan) }}">
        @csrf @method('PUT')
      ...
      <form id="del{{ $plan->id }}" method="POST"
            action="{{ route('panel.mystery-box.plans.destroy', $plan) }}" style="display:none">
        @csrf @method('DELETE')
      </form>
      @endif
    </div>
    ...
    <div class="p-card fade-up">
      <div class="p-card-header">
        <div class="p-card-title">
          <i class="bi bi-plus-lg me-1" style="color:var(--p-accent)"></i>
          Yangi tarif
        </div>
      </div>
      <form method="POST" action="{{ route('panel.mystery-box.plans.store') }}">
        @csrf
        <div style="padding:0 18px 18px">
          <div class="row g-3">
            <div class="col-12">
