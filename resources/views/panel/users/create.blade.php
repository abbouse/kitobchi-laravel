...
@section('breadcrumb', 'Panel / Foydalanuvchilar / Yangi')

@section('content')

<x-panel.page-header back-href="{{ route('panel.users.index') }}">
  <x-slot name="heading">Yangi foydalanuvchi</x-slot>
  <x-slot name="meta">Yangi foydalanuvchi profili yarating</x-slot>
</x-panel.page-header>
      ...
      <div class="p-card mb-4 fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          <div class="">
            ...
            <input type="text" name="name"
                   ...
                   value="{{ old('name') }}" required maxlength="100" placeholder="Ism kiriting">
          ...
          <div class="">
            ...
            <input type="text" name="lastname"
                   ...
                   value="{{ old('lastname') }}" maxlength="100" placeholder="Familiya kiriting">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          ...
          <div class="">
            ...
            <input type="email" name="email"
                   ...
                   value="{{ old('email') }}" maxlength="191" placeholder="example@email.com">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          <div class="">
            ...
            <select name="sex" class="p-form-control @error('sex') is-invalid @enderror">
          ...
          <div class="">
            ...
            <input type="number" name="real_balance"
                   class="p-form-control @error('real_balance') is-invalid @enderror"
                   value="{{ old('real_balance', 0) }}" min="0" step="100" placeholder="0">
            @error('real_balance')<div class="invalid-feedback">{{ $message }}</div>@enderror
          </div>
        </div>
