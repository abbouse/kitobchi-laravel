...
<div class="editor-toolbar">
  ...
  <div class="sep"></div>
  <button type="button" onclick="execCmd('formatBlock',null,'{{ $id }}'); document.execCommand('formatBlock',false,'h1')" title="H1"
          onclick="execCmd('formatBlock','h1','{{ $id }}')"><b style="font-size:11px">H1</b></button>
