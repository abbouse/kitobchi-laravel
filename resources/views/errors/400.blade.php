...
@section('title', __('errors.400_title').' — '.__('errors.meta_title'))
...
@section('content')
    <div class="kc-error-card">
        ...
        <h1 class="section-heading kc-error-heading">{{ __('errors.400_title') }}</h1>
        <p class="subheading kc-error-lead">{{ __('errors.400_lead') }}</p>
