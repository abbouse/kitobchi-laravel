            ...
            <x-admin.section-card title="Kuryer ma'lumotlari" meta="Biriktirilgan kuryerning profil va aloqa ma’lumotlari.">
                @if($courierOrder->courier)
                    ...
                    <div class="row g-4 small">
                        ...
                        <div class="col-sm-6"><div class="text-secondary mb-1">Holat</div><div>{{ \App\Support\AdminOrderStatusPresenter::courierProfile($courierOrder->courier->status ?? null) }}</div></div>
                    </div>
                @else
