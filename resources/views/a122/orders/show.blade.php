    ...
    <section class="xl:col-span-4 space-y-4">
      ...
      <div class="a122-section-body">
        <dl class="space-y-3">
          ...
          <div class="flex justify-between gap-3"><dt class="metric-label">Cashback oqimi</dt><dd class="font-semibold">{{ $cashbackFlowLabel }}</dd></div>
          ...
          <div class="flex justify-between gap-3"><dt class="metric-label">Cashback push</dt><dd class="font-semibold">{{ $cashbackNotifiedAt?->format('d.m.Y H:i') ?: '—' }}</dd></div>
      ...
      <div class="a122-section-body">
        <div class="space-y-2 text-sm">
          ...
          <div><span class="metric-label">In-store buyurtmami</span><div class="font-semibold mt-1">{{ $isInstore ? 'Ha' : "Yo'q" }}</div></div>
