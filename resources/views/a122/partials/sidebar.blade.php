...
<aside
  ...
  <div class="flex items-center justify-between px-4 pt-5 pb-4">
    <a href="{{ route('admin.dashboard') }}" class="sidebar-brand min-w-0">
      <img src="{{ asset('images/logo/logo_black.png') }}" alt="Kitobchi" class="sidebar-brand-logo sidebar-brand-logo--light">
      <img src="{{ asset('images/logo/logo_white.png') }}" alt="Kitobchi" class="sidebar-brand-logo sidebar-brand-logo--dark">
        ...
        <div class="space-y-0.5 mt-0.5">
          @foreach ($g['items'] as $it)
            ...
            >
              ...
              <span class="sidebar-link__label flex-1 truncate">{{ $it['label'] }}</span>
            </a>
          @endforeach
        </div>
      </div>
