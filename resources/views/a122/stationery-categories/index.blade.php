...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
  ...
  <div class="flex items-center gap-2">
    ...
    <a href="{{ route('admin.stationery-categories.create') }}" class="btn btn-primary">
      ...
      <tbody>
        @forelse($categories as $cat)
          <tr>
            ...
            <td><span class="font-semibold">{{ $cat->stationeries_count }}</span></td>
            <td>
              @if($cat->is_active)
            ...
            <td>
              <div class="flex items-center justify-end gap-1">
                ...
                <a href="{{ route('admin.stationery-categories.edit', $cat) }}" class="btn-ghost p-2 rounded-lg">
