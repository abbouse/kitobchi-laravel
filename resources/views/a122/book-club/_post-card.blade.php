  ...
  <div class="dash-card-body">
    ...
    <div class="flex items-start justify-between mb-3">
      ...
      <div class="flex gap-1">
        <a href="{{ route('admin.book-club.show', $post) }}" class="btn-p ghost sm">
          <i class="bi bi-eye"></i>
        </a>
        <a href="{{ route('admin.book-club.edit', $post) }}" class="btn-p ghost sm">
          <i class="bi bi-pencil"></i>
        </a>
        <form method="POST" action="{{ route('admin.book-club.destroy', $post) }}"
