...
<div class="kc-page-inner w-full min-w-0">
    <x-a122.page-header back-href="{{ route('admin.book-club.show', $bookClub) }}">
  ...
  <x-slot name="meta">Muallif:
    ...
    <form method="POST" action="{{ route('admin.book-club.update', $bookClub) }}">
      @csrf @method('PUT')
      ...
      <div class="flex gap-2 justify-end fade-up">
        <a href="{{ route('admin.book-club.show', $bookClub) }}" class="btn-p ghost">
          Bekor qilish
        </a>
