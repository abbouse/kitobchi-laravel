...
<div class="a122-index-header">
  <div>
    ...
    <div class="a122-index-header__meta">{{ $promocodes->total() }} ta promokod topildi</div>
  </div>
  <div class="a122-index-header__actions">
    <form method="GET" class="a122-index-search-form">
      <input type="hidden" name="tab" value="{{ $tab }}">
      <i class="bi bi-search"></i>
      <input type="search" name="search" value="{{ request('search') }}" placeholder="Kod yoki ID bo'yicha qidiring">
    </form>
...
<div class="p-card p-0">
        ...
        <tr>
          ...
          <td>
            <div class="flex gap-1">
              <a href="{{ route('admin.promocodes.show', $p) }}" class="btn-p ghost sm"><i class="bi bi-eye"></i></a>
              <a href="{{ route('admin.promocodes.edit', $p) }}" class="btn-p ghost sm"><i class="bi bi-pencil"></i></a>
              <form method="POST" action="{{ route('admin.promocodes.destroy', $p) }}"
  ...
  {{ $promocodes->links('a122.partials.pagination') }}
  @endif
</div>
@endsection
