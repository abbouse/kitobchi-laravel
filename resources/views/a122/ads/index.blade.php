...
<div class="a122-index-header">
  <div>
    ...
    <div class="a122-index-header__meta">{{ $ads->total() }} ta reklama topildi</div>
  </div>
  <div class="a122-index-header__actions">
    <form method="GET" class="a122-index-search-form">
      ...
      <input type="search" name="search" value="{{ request('search') }}" placeholder="ID yoki seller ID bo'yicha qidiring">
    </form>
  </div>
</div>
...
<div class="filter-bar mb-3">
  <form method="GET" class="a122-index-search-form flex flex-wrap gap-2">
    ...
    <a href="{{ route('admin.ads.index',['tab'=>$tab]) }}" class="btn-p ghost"><i class="bi bi-x"></i></a>
  </form>
</div>
...
<div class="p-card p-0">
    ...
    <table class="p-table" data-index-grid style="min-width:780px">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            @if($ad->seller)
            <a href="{{ route('admin.sellers.show', $ad->seller_id) }}"
          ...
          <td>
            <div class="flex gap-1">
              ...
              @endif
              <a href="{{ route('admin.ads.show', $ad) }}" class="btn-p ghost sm"><i class="bi bi-eye"></i></a>
            </div>
          </td>
        </tr>
        @empty
  ...
  @if($ads->hasPages())
  {{ $ads->links('a122.partials.pagination') }}
  @endif
</div>
@endsection
