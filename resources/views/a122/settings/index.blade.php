          ...
          <div class="grid grid-cols-1 gap-3">
            ...
            <div>
              ...
              <input type="text" name="telegram_redirect_uri_ios" class="p-form-control"
                     value="{{ old('telegram_redirect_uri_ios', $project?->telegram_redirect_uri_ios ?? 'kitobchi://tglogin') }}"
            ...
            <div>
              ...
              <input type="text" name="telegram_redirect_uri_android" class="p-form-control"
                     value="{{ old('telegram_redirect_uri_android', $project?->telegram_redirect_uri_android ?? 'https://app2234481912-login.tg.dev') }}"
