        ...
        <section style="padding:1rem 0 2.5rem;">
            <div style="width:100%;max-width:var(--ui-container);margin:0 auto;padding:0 1rem;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;">
                    ...
                    <a href="{{ route('web.catalog') }}" style="font-size:0.875rem;font-weight:700;color:var(--color-tima-500);text-decoration:none;">
                        Barchasi →
                    </a>
                </div>
            ...
            <section style="padding:1.5rem 0 2.5rem;border-top:1px solid #f1f5f9;">
                <div style="width:100%;max-width:var(--ui-container);margin:0 auto;padding:0 1rem;">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;">
                        ...
                        <a href="{{ route('web.catalog', ['category' => $section->category->id]) }}" style="font-size:0.875rem;font-weight:700;color:var(--color-tima-500);text-decoration:none;">
                            Barchasi →
                        </a>
                    </div>
