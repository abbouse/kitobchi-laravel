...
@section('title', 'Foydalanish Shartlari')
...
@section('content')
    ...
    <div class="lang-content active" id="content-uz">
        ...
        <div class="doc-section">
            ...
            <p class="doc-paragraph">
                <strong>8.4.</strong> Premium obuna uchun avtomatik to'lov (avtospisanie) shartlari alohida <a href="{{ route('legal.subscription') }}">Premium Obuna Ofertasida</a> belgilangan.
            </p>
        </div>
        ...
        <div class="doc-section">
            ...
            <p class="doc-paragraph">
                <strong>9.1.</strong> Raqamli xizmatlar (premium obuna) va elektron mahsulotlar uchun qaytarish siyosati <a href="{{ route('legal.subscription') }}">Premium Obuna Ofertasida</a> batafsil bayon etilgan.
            </p>
