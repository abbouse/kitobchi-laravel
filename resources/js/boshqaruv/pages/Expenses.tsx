...
export default function Expenses() {
  ...
  return <div>
    <div className="page-head"><div><h1 className="page-title">Chiqimlar</h1><PageCrumbs /><p className="page-subtitle">Marketplace operatsion xarajatlari va analitika uchun ledger</p></div><Button onClick={() => setEditing(null)}><i className="bi bi-plus-lg me-1"></i>Chiqim qo‘shish</Button></div>
