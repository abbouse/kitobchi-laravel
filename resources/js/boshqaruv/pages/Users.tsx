...
interface UserDetail {
  ...
  followers: Row[]; following: Row[]; searchHistory: Row[]; giftCertificates: Row[]; mysteryBoxes: Row[]; actions: Record<string, string>;
}
