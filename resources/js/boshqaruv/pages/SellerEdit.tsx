  ...
  return (
    <form onSubmit={submit}>
      <div className="d-flex align-items-center gap-3 mx-1 mb-3 min-w-0">
        <Link href={detailUrl} className="btn btn-light-primary icon-btn b-r-22 flex-shrink-0" title="Sotuvchi profiliga qaytish">
          <i className="ti ti-arrow-left f-s-18"></i>
        </Link>
        <div className="min-w-0">
          <h4 className="main-title mb-0 txt-ellipsis-1">Sellerni tahrirlash</h4>
          <PageCrumbs />
          <p className="mb-0 text-secondary">{seller.name} · ID #{seller.id}</p>
        </div>
      </div>
                ...
                <div className="col-md-6">
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {sellerActivityOptions.map((option) => (
                      <label className="badge text-light-secondary cursor-pointer" key={option.value}>
                        <input
...
<div className="card-body">
              <div className="row g-3">
                ...
                {commissionMode === 'individual'
                  ...
                  : <div className="col-md-6"><div className="b-1-light b-r-15 p-3 h-100 d-flex align-items-center text-muted f-s-13">Buyurtma summasiga mos global komissiya tarifi qo'llanadi.</div></div>}

                {activePromotion ? (
                  <div className="col-12">
                    <div className="b-1-light b-r-15 p-3 border-success-subtle bg-light-success">
                      <div className="f-w-600">Faol imtiyoz: {activePromotion.type === 'free' ? 'Komissiyasiz' : `${activePromotion.value}% komissiya`}</div>
                      <div className="f-s-13 text-muted mt-1">{activePromotion.reason} · {activePromotion.endsAtLabel || '—'} gacha</div>
                    </div>
                  </div>
                ) : null}
                ...
                {(seller.commission?.history || []).length ? (
                  <div className="col-12">
                    <div className="b-1-light b-r-15 p-3">
                      <div className="f-w-600 mb-2">Imtiyoz tarixi</div>
...
<div className="card-body">
              <div className="row g-3">
                ...
                {!legalType ? <div className="col-md-6"><div className="b-1-light b-r-15 p-3 h-100 d-flex align-items-center text-muted">Avval seller yuridik turini tanlang.</div></div> : null}
...
<div className="card-body">
      ...
      <div className="card card-body flex-row align-items-center gap-3 position-sticky shadow mb-0 mt-3" style={{ bottom: 60, zIndex: 15 }}>
        <div className="text-muted f-s-13 d-none d-md-block">{seller.name} ma'lumotlarini tahrirlamoqdasiz</div>
        <div className="d-flex gap-2 ms-auto">
          ...
          <button type="submit" className="btn btn-primary border-0" disabled={saving}>
            {saving ? <><span className="spinner-border spinner-border-sm me-2"></span>Saqlanmoqda...</> : <><i className="ti ti-circle-check me-1"></i>Saqlash</>}
          </button>
        </div>
      </div>
    </form>
