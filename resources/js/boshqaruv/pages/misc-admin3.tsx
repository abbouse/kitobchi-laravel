    ...
    <div>
      ...
      <div className="card-panel">
        <div className="table-responsive"><table className="data-table">
          ...
          <tbody>{news.map(item => (
            <tr key={item.id}>
              <td className="fw-semibold" style={{ color: 'var(--kc-cat-indigo)' }}>#{item.id}</td>
      ...
      <div className="card-panel">
        ...
        <div className="table-responsive"><table className="data-table">
          ...
          <tbody>{conversations.map(c => (
            <tr key={c.id}>
              <td className="fw-semibold" style={{ color: 'var(--kc-cat-indigo)' }}>#{c.id}</td>
        ...
        <div className="table-responsive"><table className="data-table">
          ...
          <tbody>{notifications.map(notification => (
            <tr key={notification.id}>
              <td className="fw-semibold" style={{ color: 'var(--kc-cat-indigo)' }}>#{notification.id}</td>
              <td>
