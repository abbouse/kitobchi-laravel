  ...
  return (
    <div>
      <div className="d-flex align-items-end justify-content-between flex-wrap gap-3 mx-1 mb-3">
        <div><h4 className="main-title mb-0">Kitob kategoriyalari</h4><PageCrumbs /><p className="mb-0 text-secondary">Jami {categories.length} ta kategoriya</p></div>
      ...
      <CategoryFormModal category={editing} baseUrl="/boshqaruv/book-categories" onHide={() => setEditing(null)} />
    </div>
  );
}
    ...
    <Modal show={!!category} onHide={onHide} centered>
      <form onSubmit={submit}>
        ...
        <Modal.Body><div className="row g-3">
          ...
          <div className="col-12 f-s-13 text-muted">Fiskal chek uchun. Bo'sh qolsa .env dagi umumiy kitob kodi ishlatiladi. Kodlarni tasnif.soliq.uz dan oling.</div>
        </div></Modal.Body>
