...
export const categoryShare = [
  { name: 'Badiiy', value: 38, color: 'rgba(var(--primary), 1)', revenue: 18_513_790, profit: 7_405_516, margin: 40, returns: 4.2, units: 892 },
  { name: 'Ilmiy', value: 22, color: 'rgba(var(--primary), 1)', revenue: 10_718_510, profit: 4_823_329, margin: 45, returns: 2.8, units: 412 },
  { name: 'Bolalar', value: 18, color: 'rgba(var(--danger), 1)', revenue: 8_769_690, profit: 3_507_876, margin: 40, returns: 5.1, units: 624 },
  { name: 'Kanselyariya', value: 14, color: 'rgba(var(--success), 1)', revenue: 6_820_870, profit: 2_728_348, margin: 40, returns: 3.5, units: 1845 },
  { name: 'Darslik', value: 8, color: 'rgba(var(--warning-dark), 1)', revenue: 3_897_640, profit: 1_169_292, margin: 30, returns: 6.8, units: 312 },
];
...
export const recentActivity = [
  { icon: 'ti-shopping-bag', color: 'rgba(var(--success), 1)', text: "Yangi buyurtma #ORD-8848 qabul qilindi", time: '2 daqiqa oldin', amount: 745000 },
  { icon: 'ti-user-plus', color: 'rgba(var(--primary), 1)', text: "Yangi mijoz ro'yxatdan o'tdi", time: '8 daqiqa oldin', amount: 0 },
  { icon: 'ti-truck', color: 'rgba(var(--warning-dark), 1)', text: 'Buyurtma #ORD-8843 Hub-2 ga yetkazildi', time: '15 daqiqa oldin', amount: 0 },
  { icon: 'ti-star', color: 'rgba(var(--danger), 1)', text: 'Dilnoza R. 5 yulduzli sharh qoldirdi', time: '22 daqiqa oldin', amount: 0 },
  { icon: 'ti-package', color: 'rgba(var(--primary), 1)', text: "Hub-1 dan 24 ta buyurtma pochta orqali jo'natildi", time: '30 daqiqa oldin', amount: 0 },
  { icon: 'ti-cash', color: 'rgba(var(--success), 1)', text: "Seller 'Kitob olami' ga 2,450,000 so'm to'landi", time: '45 daqiqa oldin', amount: 2450000 },
];
...
export const customerSegments = [
  { segment: 'VIP (Top 5%)', count: 171, share: 5.0, revenue: 14_840_000, avgSpent: 868_000, orders: 18.2, retention: 94.5, color: 'rgba(var(--warning-dark), 1)' },
  { segment: 'Loyal', count: 892, share: 26.1, revenue: 16_920_000, avgSpent: 189_700, orders: 5.8, retention: 82.4, color: 'rgba(var(--success), 1)' },
  { segment: 'Occasional', count: 1428, share: 41.9, revenue: 11_420_000, avgSpent: 79_970, orders: 2.1, retention: 58.6, color: 'rgba(var(--info), 1)' },
  { segment: 'New (30 kun)', count: 384, share: 11.3, revenue: 3_840_000, avgSpent: 10_000, orders: 1.0, retention: 0, color: 'rgba(var(--danger), 1)' },
  { segment: 'Churned (60+ kun)', count: 537, share: 15.7, revenue: 1_890_000, avgSpent: 0, orders: 0, retention: 0, color: 'rgba(var(--danger), 1)' },
];
...
export const conversionFunnel = [
  { stage: 'Saytga tashrif', value: 56840, percent: 100, color: 'rgba(var(--primary), 1)' },
  { stage: 'Mahsulot ko\'rish', value: 34120, percent: 60, color: 'rgba(var(--primary), 1)' },
  { stage: 'Savatga qo\'shish', value: 8420, percent: 14.8, color: 'rgba(var(--danger), 1)' },
  { stage: 'Checkout boshlash', value: 4280, percent: 7.5, color: 'rgba(var(--warning-dark), 1)' },
  { stage: 'Xaridni yakunlash', value: 1944, percent: 3.42, color: 'rgba(var(--success), 1)' },
];
...
export const appPlatformData = [
  { platform: 'Android', activeUsers: 2684, orders: 904, revenue: 34_290_000, profit: 13_716_000, crashRate: 0.42, avgSession: '6m 18s', conversion: 3.7, appVersion: '2.8.4', color: 'rgba(var(--success), 1)' },
  { platform: 'iOS', activeUsers: 728, orders: 380, revenue: 14_430_500, profit: 5_772_200, crashRate: 0.18, avgSession: '7m 42s', conversion: 4.1, appVersion: '2.8.1', color: 'rgba(var(--info), 1)' },
];
...
export const appEventFunnel = [
  { stage: 'App launch', users: 56840, drop: 0, conversion: 100, problem: 'Bazaviy event', color: 'rgba(var(--primary), 1)' },
  { stage: 'Home loaded', users: 53620, drop: 5.7, conversion: 94.3, problem: 'Sekin internet / cache', color: 'rgba(var(--primary-dark), 1)' },
  { stage: 'Product list viewed', users: 34120, drop: 36.4, conversion: 60.0, problem: 'Home -> katalog o\'tish past', color: 'rgba(var(--primary), 1)' },
  { stage: 'Product detail viewed', users: 18440, drop: 45.9, conversion: 32.4, problem: 'CTR past / rasm va narx optimizatsiya', color: 'rgba(var(--danger), 1)' },
  { stage: 'Added to cart', users: 8420, drop: 54.3, conversion: 14.8, problem: 'Narx yoki mavjudlik muammosi', color: 'rgba(var(--danger), 1)' },
  { stage: 'Checkout started', users: 4280, drop: 49.2, conversion: 7.5, problem: 'Yetkazish narxi va forma uzun', color: 'rgba(var(--warning-dark), 1)' },
  { stage: 'Payment method selected', users: 2580, drop: 39.7, conversion: 4.54, problem: 'Karta ulashdagi ishonch / naqd tanlash', color: 'rgba(var(--info), 1)' },
  { stage: 'Order completed', users: 1944, drop: 24.7, conversion: 3.42, problem: 'Karta xatosi va bekor qilish', color: 'rgba(var(--success), 1)' },
];
...
export const operationalQuality = [
  { metric: 'Laravel API p95 latency', value: '186ms', target: '<250ms', status: 'Yaxshi', color: 'rgba(var(--success), 1)' },
  { metric: 'Order create error rate', value: '0.18%', target: '<0.5%', status: 'Yaxshi', color: 'rgba(var(--success), 1)' },
  { metric: 'Payment callback delay', value: '1.8s', target: '<3s', status: 'Yaxshi', color: 'rgba(var(--success), 1)' },
  { metric: 'Admin processing SLA', value: '12m', target: '<15m', status: 'Yaxshi', color: 'rgba(var(--success), 1)' },
  { metric: 'Courier assignment SLA', value: '26m', target: '<20m', status: 'Diqqat', color: 'rgba(var(--warning-dark), 1)' },
  { metric: 'Stock sync lag', value: '4m', target: '<5m', status: 'Yaxshi', color: 'rgba(var(--success), 1)' },
];
